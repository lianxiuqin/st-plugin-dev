// agent_plugin_dev/ui-chat-thinking-plugin/src/web.tsx —— 思维链展示风格包(demo 视觉注入):
// 宿主(ui-chat-plugin)生成链块 DOM(.uchat-chain*)与气泡;本包只注入 demo 视觉:思考中虚线态 →
// 收起态灰字行、展开区浅底,与静态气泡接管。全包无任何 emoji 字符。
